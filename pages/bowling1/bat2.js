...
function CompMove() {
    ...
    document.getElementById("comp").textContent = `Computer played ${i}`
    return i;
...
function addRuns(num) {
    runs += num;
    document.getElementById("compScore").textContent = `Your score: ${runs}`;
    if (runs >= passedValue) { win(); }

}
function win() {
    document.getElementById("out").textContent = "You Win";
...
function out() {
    ...
    document.getElementById("compScore").textContent = `Your Score:${runs}`;
    document.getElementById("out").textContent = `Computer wins by ${diff} runs`;
